...
class pengaduan_itController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pengaduan_it.tampil_pengaduan_it', compact('pengaduan_it'));
    }

    public function tambah()
    {
        return view('pengaduan_it.tambah_pengaduan_it');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('pengaduan_it.edit_pengaduan_it', compact('pengaduan_it'));
    }
    ...
    {
        $pengaduan_it = pengaduanItModel::findOrFail($id);
        return view('pengaduan_it.update_pengaduan_it', compact('pengaduan_it'));
    }
